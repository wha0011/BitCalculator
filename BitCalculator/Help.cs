...
namespace DevTools
{
    public static class Help
    {
        public static string DEFAULTFUNCS = @"SYSTEM FUNCTIONS:" + "\n"
                                          ...
                                          + @"convert()///Converts images to a different format. <new>For example: " + "*convert \"C:\\Users\\username\\Downloads\\item2.jpg\" : .jpg*" + @"<new>Will convert this image *image.jpg* into a png named *image.png*. Can parse in most file formats. Can only output .png, .jpg, .ico" + "\n"
     ;
    }
}