...
namespace DevTools
{
    public static class Help
    {
        public static string DEFAULTFUNCS = @"SYSTEM FUNCTIONS:" + "\n"
                                          ...
                                          + @"b_()///Show the binary value as a ulong<new>Used like this: *b_10110010*\\\" + "\n"
                                          ...
                                          + @"zip()///Zips a file or a directory. <new>For example: " + "*zip \"C:\\Users\\username\\Downloads\\item2.txt\"*" + @"<new>Will zip this singular file into a new .zip folder called '*item2.zip*' located in the *Downloads* folder<new>You can specify the name of the result file like so: <new>" + "zip \"C:\\Users\\username\\Downloads\\item2.txt\" : \"C:\\Users\\username\\Downloads\\randomfile.zip\"" + @"<new>This will zip the '*item2.txt*' into a zip file called '*randomFile.zip*'<new>You can zip multiple files like so:<new>" + "zip \"C:\\Users\\username\\Downloads\\item.docx\",\"C:\\Users\\username\\Downloads\\item2.txt\" : \"C:\\Users\\username\\Downloads\\randomfile.zip\"" + @"<new>Seperate files aer seperated by a comma" + "\n"
                                          + @"simplify()///Allows you to simplify a fraction. For example: <new>*simplify(2/4)* will print out *1/2* as its result. <new>*simplify(4/2)* will print out *2* as the result<new>Decimals can also be used like so: <new>*simplify(3/1.5)* which will print out *2* as the result\\\" + "\n"
   ;
    }
}